...
#ifndef __sobel_filter_mac_bkb__HH__
#define __sobel_filter_mac_bkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_filter_mac_bkb) {
    ...
    SC_CTOR(sobel_filter_mac_bkb):  simcore_mac_0_U ("simcore_mac_0_U") {
