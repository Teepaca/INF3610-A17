...
struct getVal : public sc_module {
    ...
    sc_signal< sc_lv<13> > tmp1_reg_143;
    sc_signal< sc_lv<32> > Y_addr_reg_148;
    ...
    sc_signal< sc_lv<22> > tmp_52_fu_117_p1;
    sc_signal< sc_lv<22> > sum_fu_121_p2;
    sc_signal< sc_lv<32> > sum_cast_fu_127_p1;
