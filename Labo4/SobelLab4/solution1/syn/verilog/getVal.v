...
reg   [12:0] tmp1_reg_143;
reg   [31:0] Y_addr_reg_148;
...
wire   [21:0] tmp_52_fu_117_p1;
wire   [21:0] sum_fu_121_p2;
wire  signed [31:0] sum_cast_fu_127_p1;
reg   [9:0] ap_NS_fsm;
    ...
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_CS_fsm_state3)) begin
            if ((ap_sig_ioackin_m_axi_Y_ARREADY == 1'b1)) begin
                ap_reg_ioackin_m_axi_Y_ARREADY <= 1'b0;
            end else if ((1'b1 == m_axi_Y_ARREADY)) begin
...
always @ (*) begin
    if ((((1'b0 == ap_start) & (1'b1 == ap_CS_fsm_state1)) | ((1'b1 == ap_CS_fsm_state10) & (m_axi_Y_RVALID == 1'b1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state10) & (m_axi_Y_RVALID == 1'b1))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) & (1'b0 == ap_reg_ioackin_m_axi_Y_ARREADY))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((1'b1 == ap_CS_fsm_state3) & (ap_sig_ioackin_m_axi_Y_ARREADY == 1'b1))) begin
...
assign m_axi_Y_ARADDR = Y_addr_reg_148;
...
assign sum1_fu_131_p2 = ($signed(inter_pix1) + $signed(sum_cast_fu_127_p1));

assign sum_cast_fu_127_p1 = $signed(sum_fu_121_p2);

assign sum_fu_121_p2 = ($signed(tmp1_cast_fu_114_p1) + $signed(tmp_52_fu_117_p1));

assign tmp1_cast_fu_114_p1 = $signed(tmp1_reg_143);

assign tmp1_fu_108_p2 = ($signed(tmp_fu_98_p2) + $signed(xDiff_cast_fu_104_p1));

assign tmp_52_fu_117_p1 = index[21:0];
