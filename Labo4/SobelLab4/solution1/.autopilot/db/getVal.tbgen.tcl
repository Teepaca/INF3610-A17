...
set C_modelArgMapList {[ 
	{ "Name" : "index", "interface" : "wire", "bitwidth" : 23, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "inter_pix1", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ inter_pix1 sc_in sc_lv 32 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "inter_pix1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "inter_pix1", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	inter_pix1 { ap_none {  { inter_pix1 in_data 0 32 } } }
}
