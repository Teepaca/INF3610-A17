...
CONFIG.C_AUX_RST_WIDTH {1} \
  ...
  # Create port connections
  connect_bd_net -net clk_map_aclk1_net [get_bd_pins M00_ACLK] [get_bd_pins S00_ACLK] [get_bd_pins aclk1] [get_bd_pins swbd_aclk] [get_bd_pins psr_aclk1/slowest_sync_clk]
  connect_bd_net -net clk_map_aresetn_net [get_bd_pins aresetn] [get_bd_pins psr_aclk1/aux_reset_in]
  connect_bd_net -net one_dout [get_bd_pins one/dout] [get_bd_pins psr_aclk1/ext_reset_in]
  connect_bd_net -net psr_aclk1_interconnect_aresetn [get_bd_pins M00_ARESETN] [get_bd_pins S00_ARESETN] [get_bd_pins swbd_aresetn] [get_bd_pins psr_aclk1/interconnect_aresetn]
