...
{
	return Y[(index + (yDiff * img_width) + xDiff + 4 * img_width) % (4 * img_width)]; // Version modifiée pour tenir compte de la structure de la cache.
	// Elle permet entre autres d'accéder aux index de tableau "négatifs" en allant chercher la ligne correspondante dans la cache.
};
