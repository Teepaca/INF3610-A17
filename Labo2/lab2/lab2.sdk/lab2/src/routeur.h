...
#define	MUTEX_PCREES_PRIO			7
#define MUTEX_PTRAITES_PRIO 		6
#define MUTEX_PSOURCEREJETE_PRIO	5
#define MUTEX_RUNNING_PRIO			4
#define MUTEX_PRINTING_PRIO			3
#define MUTEX_MEMORY_PRIO			2
